      ...
      <view class="tn-flex tn-flex-row-between tn-flex-col-center tn-margin">
        <view class="justify-content-item">
          <view class="tn-flex tn-flex-col-center tn-flex-row-left">
            <view class="logo-pic tn-shadow-blur" style="background-image:url('https://tnuiimage.tnkjapp.com/blogger/content_1.jpeg')">
        ...
        content: [
          {
            ...
            mainImage:[
              'https://tnuiimage.tnkjapp.com/blogger/onepiece-1.jpg',
              'https://tnuiimage.tnkjapp.com/blogger/onepiece-2.jpg',
            ],
            viewUser: {
              latestUserAvatar: [
