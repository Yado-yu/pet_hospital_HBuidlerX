<template>
  <view class="template-blogger tn-safe-area-inset-bottom">
    ...
    <!-- 立体头像-->
    <view class='cube' :style="'background-image: url(https://tnuiimage.tnkjapp.com/blogger/bg_image_1.jpg);'">
        ...
        <view class="tn-flex tn-flex-row-between tn-flex-col-center tn-margin-bottom">
          <view class="justify-content-item">
            <view class="tn-flex tn-flex-col-center tn-flex-row-left">
              <!-- 图标logo -->
              <view class="ad-pic tn-shadow-blur" style="background-image:url('https://tnuiimage.tnkjapp.com/logo/logo2.png')">
                <view class="ad-image">
                </view>
              </view>
