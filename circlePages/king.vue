  ...
  <view class="template-king tn-safe-area-inset-bottom">
    ...
    <view>
      <view class="tn-strip-bottom">
        ...
        <view class="slideshow-image" style="background-image: url('https://tnuiimage.tnkjapp.com/blogger/blogger_beibei.jpg')">
        </view>
      ...
      <view class="king-list tn-margin-top-sm">
        ...
        <view class='king-item tn-color-red tn-icon-circle-fill'>
          ...
          <view class="bg-img-cont img-solid"
            style="background-image:url(https://tnuiimage.tnkjapp.com/advertise/7.jpg);">
          </view>
          <view class="resume2">
        ...
        <view class='king-item tn-color-red tn-icon-circle-fill'>
          ...
          <view class="bg-img-cont img-solid"
            style="background-image:url(https://tnuiimage.tnkjapp.com/advertise/8.jpg);">
          </view>
          <view class="resume2">
