<template>
  <view class="template-product tn-safe-area-inset-bottom">
	...
	<view class="">
	  <image :src="currentPet.pet_pic" class="petImg"></image>
	</view>
    ...
    <view class="tn-margin">
      ...
      <view class="tn-flex tn-flex-row-between tn-margin-top">
        <view class="justify-content-item tn-text-bold tn-color-purplered">
          <text class="" style="font-size: 30rpx;">{{currentPet.species}}</text>
        </view>
      </view>
    </view>
    ...
    <view class="tn-padding-top-sm tn-padding-bottom-sm">
      <tn-list-cell :hover="true" :unlined="true" :radius="true" :fontSize="34">
        <view class="tn-flex tn-flex-col-center">
          <view class="tn-flex-1">我的主人</view>
          <view class="tn-margin-left-sm" style="font-size: 28rpx;">{{userInfo.nickname}}</view>
        </view>
      </tn-list-cell>
      <tn-list-cell :hover="true" :unlined="true" :radius="true" :fontSize="34">
        <view class="tn-flex tn-flex-col-center">
          <view class="tn-flex-1">我的体重</view>
          <view class="tn-margin-left-sm" style="font-size: 28rpx;">{{currentPet.weight}} kg</view>
        </view>
      </tn-list-cell>
      <tn-list-cell :hover="true" :unlined="true" :radius="true" :fontSize="34">
        <view class="tn-flex tn-flex-col-center">
          <view class="tn-flex-1">我的性别</view>
          <view class="tn-margin-left-sm" style="font-size: 28rpx;">{{currentPet.pet_gender}}</view>
        </view>
      </tn-list-cell>
	  <tn-list-cell :hover="true" :unlined="true" :radius="true" :fontSize="34">
	    <view class="tn-flex tn-flex-col-center">
	      <view class="tn-flex-1">我的绝育状态</view>
	      <view class="tn-margin-left-sm" style="font-size: 28rpx;">{{currentPet.isSterilization}}</view>
	    </view>
	  </tn-list-cell>
    </view>
    ...
    <view class="footerfixed dd-glass tn-padding-left-sm tn-padding-right tn-padding-top-xs tn-padding-bottom-sm">
      <tn-goods-nav :options="countOptions" :buttonGroups="customButtonGroups" buttonType="round" :safeAreaInsetBottom="true" @optionClick="onOptionClick" @buttonClick="toUpdatePet"></tn-goods-nav>
    </view>
