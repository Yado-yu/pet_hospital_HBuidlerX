      ...
      <view class="tn-flex tn-flex-row-between tn-flex-col-center tn-margin">
        <view class="justify-content-item">
          <view class="tn-flex tn-flex-col-center tn-flex-row-left">
            <view class="logo-pic tn-shadow-blur" style="background-image:url('https://tnuiimage.tnkjapp.com/blogger/blogger_beibei.jpg')">
    ...
    <view class="tabbar footerfixed dd-glass" style="border-radius: 100rpx;">
      <view class="action">
        <view class="bar-icon">
          ...
          <!-- <image class="" src='https://tnuiimage.tnkjapp.com/logo/logo2.png'></image> -->
        </view>
