<template>
  <view class="template-money tn-safe-area-inset-bottom">
    ...
    <!-- <view class="top-backgroup">
      <image src='https://tnuiimage.tnkjapp.com/money/money-bg.jpg' mode='heightFix' class='backgroud-image'></image>
    </view> -->
    

    <!-- banner start-->
    <view class="tn-flex tn-flex-wrap tn-padding-xs tn-margin-top-xl" :style="{paddingTop: vuex_custom_bar_height + 'px'}">
      <view class=" " style="width: 100%;" @click="tn('/minePages/signed')">
        <view class="image-pic tn-shadow-blur" style="background-image:url('https://tnuiimage.tnkjapp.com/new/integral.png')">
