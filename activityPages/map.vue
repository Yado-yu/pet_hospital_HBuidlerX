   ...
   <view class="indication">
    ...
    <view class="map">
        <view class="map-location-1" @click="showModal">
          <image class="map-house-img" mode="widthFix" src="https://tnuiimage.tnkjapp.com/new/place1.png">
          </image>
        ...
        <view class="map-location-2" @click="showModal">
          <image class="map-house-img" mode="widthFix" src="https://tnuiimage.tnkjapp.com/new/place2.png">
          </image>
        ...
        <view class="map-location-3" @click="showModal">
          <image class="map-house-img" mode="widthFix" src="https://tnuiimage.tnkjapp.com/new/place3.png">
          </image>
        ...
        <view class="map-location-4" @click="showModal">
          <image class="map-house-img" mode="widthFix" src="https://tnuiimage.tnkjapp.com/new/place4.png">
          </image>
        ...
        <view class="map-location-5 punch-no tnxuanfu-map" @click="showModal">
          <image class="map-house-img" mode="widthFix" src="https://tnuiimage.tnkjapp.com/new/place5.png">
          </image>
